Read documentation/devlog.md.

The file is missing its history. It was overwritten instead of appended to. Replace the entire file with the following content exactly as written — do not add, remove, or change anything:
...
## 2026-04-12 — 01.2604.0014

- Written game/game.py with Game class — __init__, spawn_piece, get_current_cells
- No pygame imports, state only
- Syntax verified: python -m py_compile game/game.py passed
- Committed and pushed to main

Next step: add update() method to game/game.py
